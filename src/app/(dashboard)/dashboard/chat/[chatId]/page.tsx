...
const Chat = async ({ params }: ChatProps) => {
  ...
  return <div className='flex-1 justify-between flex flex-col h-full max-h-[calc(100vh-6rem)]'>
    <div className='flex sm:items-center justify-between  pt-12 md:pt-4 pb-4 border-b-2 border-gray-200'>
    ...
    sessionImg={session.user.image} chatPartner={chatPartner} chatId={chatId}/>
