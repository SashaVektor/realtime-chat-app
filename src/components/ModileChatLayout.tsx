...
interface ModileChatLayoutProps {
    friends: User[],
    session: Session,
...
const ModileChatLayout: FC<ModileChatLayoutProps> = ({ friends, session, sidebarOptions, unseenRequestCount }) => {
...
export default ModileChatLayout